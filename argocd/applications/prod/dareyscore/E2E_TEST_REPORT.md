...
- **Secrets Synced:**
  ...
  - `postgres-secret` ✅ (Status: SecretSynced)
...
- **Services:** ✅ Created
  ...
  - `postgres-service` (ClusterIP: 172.20.153.97)
  - `redis-service` (ClusterIP: 172.20.114.158)

### ⚠️ Pod Status
- **API Pods:** ❌ ImagePullBackOff (0/2 ready)
- **Worker Pods:** ❌ ImagePullBackOff (0/2 ready)
- **Migration Job:** ❌ ImagePullBackOff (0/1 ready)
- **PostgreSQL:** ⚠️ CrashLoopBackOff (0/1 ready)
